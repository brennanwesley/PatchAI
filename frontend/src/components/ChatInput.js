        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="relative group">
            <button
              type="submit"
              disabled={isDisabled}
              className={`px-4 py-3 rounded-lg flex-shrink-0 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors ${isDisabled ? 'bg-gray-200 dark:bg-gray-700 text-gray-400 dark:text-gray-600 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700 text-white'}`}
