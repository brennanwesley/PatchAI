...
def cleanup_test_users():
    ...
    try:
        ...
        # Confirm deletion
        print(f"\nThis will delete ALL {len(users)} user profiles and related data:")
        print("   - User profiles")
        ...
        confirm = input("\nAre you sure you want to delete ALL test users? (type 'DELETE' to confirm): ")
...
def main():
    """Main function"""
    print("PatchAI Test User Cleanup Script")
    print("=" * 50)
